...
#define BITMOD(value, bitNo, bitValue)                                         \
    (value = bitValue ? value | (1 << bitNo) : value & (~(1 << bitNo)))

#define TO_PTR(addr)                                                           \
    ((uint8_t *)((uintptr_t)(*(const uint8_t *)(addr)) << 8                    \
...
#define M7(I1, I2, I3, I4, I5, I6, I7)                                         \
    (M6(I1, I2, I3, I4, I5, I6) | UINT8_C(1) << I7)
